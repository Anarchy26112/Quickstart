...
public class Limelight {
    ...
    private static final double CAMERA_TILT_DEGREES = 45.0; // Camera tilted up 45 degrees
    private static final double CAMERA_HEIGHT_INCHES = 10.0; // Height of camera from ground (adjust this)
