...
public abstract class Close21Base extends OpMode {
    ...
    private static final double GATE_CYCLE_TIME = 1.15;
    private static final double SHOOTER_VELOCITY = 1570;
    private static final double HEADING_TOLERANCE_DEG = 6.0;
    ...
    private void buildPaths() {
        shootPreload = follower.pathBuilder()
                ...
                .addParametricCallback(0.92, () -> autoManipulator.releaseForShot())
                .build();
        ...
        shootFromAFinal = follower.pathBuilder()
                .addPath(new BezierLine(CollectedA, SHOOT_CYCLE_6))
                .setLinearHeadingInterpolation(CollectedA.getHeading(), SHOOT_CYCLE_6.getHeading())
                .addParametricCallback(0.92, () -> autoManipulator.releaseForShot())
                .build();

        leavePath = follower.pathBuilder()
                .addPath(new BezierLine(SHOOT_CYCLE_6, LEAVE_POINT))
                .setLinearHeadingInterpolation(SHOOT_CYCLE_6.getHeading(), LEAVE_POINT.getHeading())
                .build();
    }
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 2:
                if (autoManipulator.isShootComplete() && !follower.isBusy()) {
            ...
            case 23:
                if (pathAlmostDone(SHOOT_CYCLE_6.getHeading(), HEADING_TOLERANCE_DEG)) {
                    autoManipulator.shoot();
                    setPathState(24);
                }
                break;
